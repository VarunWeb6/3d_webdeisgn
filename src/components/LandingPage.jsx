                ...
                {["We Create", "Eye-Opening", "Presentation"].map((item, index) => (
                    <div className="masker">
                        <div className='w-fit flex items-end'>
                            ...
                            <h1 className="flex item-center uppercase h-full text-[6vw] leading-[5.5vw] tracking-tighter font-medium">
                                {item}
                            </h1>
                        </div>
                    </div>
                ))}
                <div className="border-t-[1px] border-zinc-800 mt-32 flex justify-between items-center px-5 py-5 space-x-5">
